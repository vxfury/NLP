#include "jieba/Unicode.hpp"
#include "jieba/StdExtension.hpp"
...
TEST(UnicodeTest, Test1)
{
    ...
    string actual;
    string expected = "[\"{\"rune\": \"20320\", \"offset\": 0, \"len\": 3}\", \"{\"rune\": \"22909\", "
                      "\"offset\": 3, \"len\": 3}\", \"{\"rune\": \"19990\", \"offset\": 6, \"len\": 3}\", "
                      "\"{\"rune\": \"30028\", \"offset\": 9, \"len\": 3}\"]";
    actual << runes;
