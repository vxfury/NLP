#include "jieba/DictTrie.hpp"
#include "jieba/MPSegment.hpp"
#include "gtest/gtest.h"

using namespace jieba;

static const char *const DICT_FILE = "/Users/kiran/DEVEL/NLP/tests/jieba/testdata/extra_dict/jieba.dict.small.utf8";
...
{
    DictTrie trie(DICT_FILE, "/Users/kiran/DEVEL/NLP/tests/jieba/testdata/userdict.utf8");
    string word = "云计算";
    jieba::RuneStrArray unicode;
...
{
    DictTrie trie(DICT_FILE, "/Users/kiran/DEVEL/NLP/tests/jieba/testdata/userdict.utf8", DictTrie::WordWeightMax);
    string word = "云计算";
    jieba::RuneStrArray unicode;
    ASSERT_TRUE(DecodeRunesInString(word, unicode));
    const DictUnit *unit = trie.Find(unicode.begin(), unicode.end());
