...
{
    MixSegment segment("/Users/kiran/DEVEL/NLP/corpus/jieba/jieba.dict.utf8",
...
{
    MixSegment segment("/Users/kiran/DEVEL/NLP/tests/jieba/testdata/extra_dict/jieba.dict.small.utf8",
                       "/Users/kiran/DEVEL/NLP/corpus/jieba/hmm_model.utf8");
...
TEST(MixSegmentTest, UserDict)
{
    MixSegment segment("/Users/kiran/DEVEL/NLP/tests/jieba/testdata/extra_dict/jieba.dict.small.utf8",
                       "/Users/kiran/DEVEL/NLP/corpus/jieba/hmm_model.utf8",
                       "/Users/kiran/DEVEL/NLP/corpus/jieba/user.dict.utf8");
    {
        const char *str = "令狐冲是云计算方面的专家";
        vector<string> words;
        segment.Cut(str, words);
    ...
    }
    {
        ...
        string res;
        res << words;
        ASSERT_EQ("[\"小明\", \"先\", \"就职\", \"于\", \"IBM\", \",\", \"后\", \"在\", \"日本\", "
                  "\"京都大学\", \"深造\"]",
                  res);
    }
    {
...
TEST(MixSegmentTest, TestUserDict)
{
    ...
    res << words;
    ASSERT_EQ("[\"小明\", \"先\", \"就职\", \"于\", \"I\", \"B\", \"M\", \",\", \"后\", \"在\", \"日本\", "
              "\"京都大学\", \"深造\"]",
              res);
...
TEST(MixSegmentTest, TestMultiUserDict)
{
    MixSegment segment("/Users/kiran/DEVEL/NLP/tests/jieba/testdata/extra_dict/jieba.dict.small.utf8",
                       "/Users/kiran/DEVEL/NLP/corpus/jieba/hmm_model.utf8",
                       "/Users/kiran/DEVEL/NLP/tests/jieba/testdata/userdict.utf8;/Users/kiran/DEVEL/NLP/"
                       "tests/jieba/testdata/userdict.2.utf8");
    vector<string> words;
    string res;
...
{
    MPSegment segment("/Users/kiran/DEVEL/NLP/corpus/jieba/jieba.dict.utf8");
    ;
    string s;
    vector<string> words;
...
{
    HMMSegment segment("/Users/kiran/DEVEL/NLP/corpus/jieba/hmm_model.utf8");
    ;
    {
...
{
    FullSegment segment("/Users/kiran/DEVEL/NLP/tests/jieba/testdata/extra_dict/jieba.dict.small.utf8");
    vector<string> words;
    string s;
...
{
    QuerySegment segment("/Users/kiran/DEVEL/NLP/corpus/jieba/jieba.dict.utf8",
                         "/Users/kiran/DEVEL/NLP/corpus/jieba/hmm_model.utf8", "");
    vector<string> words;
    string s1, s2;
    ...
    s2 = "小明/硕士/毕业/于/中国/科学/学院/科学院/中国科学院/计算/计算所/，/后/在/日本/京都/大学/"
         "日本京都大学/深造";
    ASSERT_EQ(s1, s2);
...
{
    QuerySegment segment("/Users/kiran/DEVEL/NLP/tests/jieba/testdata/extra_dict/jieba.dict.small.utf8",
                         "/Users/kiran/DEVEL/NLP/corpus/jieba/hmm_model.utf8",
                         "/Users/kiran/DEVEL/NLP/tests/jieba/testdata/userdict.utf8|/Users/kiran/DEVEL/NLP/"
                         "tests/jieba/testdata/userdict.english");
    vector<string> words;
    string s1, s2;
