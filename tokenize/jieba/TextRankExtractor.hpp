...
class TextRankExtractor {
  ...
  public:
    TextRankExtractor(const string &dictPath, const string &hmmFilePath, const string &stopWordPath,
    ...
    void Extract(const string &sentence, vector<Word> &keywords, size_t topN, size_t span = 5,
