...
using namespace std;
/*
 * LocalVector<T> : T must be primitive type (char , int, size_t), if T is struct or class, LocalVector<T>
 * may be dangerous.. LocalVector<T> is simple and not well-tested.
 */
